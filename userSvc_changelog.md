...
* [FIX]: Allow admins to change users' orgs: [#234](https://github.com/cinema6/cwrx/pull/234)
* [FIX]: Properly allow overriding the default applications list: [#234](https://github.com/cinema6/cwrx/pull/234)
