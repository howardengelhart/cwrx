describe('ADTECHClient(config)', function() {
    var ADTECHClient;
    var request;
    var BluebirdPromise;
    var Promise;
    ...
    beforeEach(function() {
        ...
        ADTECHClient = require('../../lib/adtechClient');
    });
    ...
    it('should exist', function() {
        expect(ADTECHClient).toEqual(jasmine.any(Function));
        expect(ADTECHClient.name).toBe('ADTECHClient');
    });
            ...
            describe('methods:', function() {
                describe('__parseBanner__(string)', function() {
                    ...
                    beforeEach(function() {
                        ...
                        result = ADTECHClient.__parseBanner__(string);
                    });
                    ...
                    describe('if an invalid banner is provided', function() {
                        ...
                        it('should throw an Error', function() {
                            expect(function() { ADTECHClient.__parseBanner__(string); }).toThrow(error);
                        });
                    });
                });
            });
    ...
    describe('instance:', function() {
        ...
        beforeEach(function() {
            ...
            client = new ADTECHClient(config);
        });
                ...
                describe('getBanner(placement, campaignId, bannerId, uuid)', function() {
                    ...
                    describe('when the request succeeds', function() {
                        ...
                        it('should fulfill with the parsed banner', function() {
                            expect(success).toHaveBeenCalledWith(ADTECHClient.__parseBanner__(string));
                        });
                    });
                });
                ...
                describe('getBanners(amount, placement, sizes, keywords, uuid)', function() {
                    ...
                    describe('when the server responds', function() {
                        ...
                        it('should fulfill with an array of parsed banners', function() {
                            expect(success).toHaveBeenCalledWith([
                                ADTECHClient.__parseBanner__(response.ADTECH_MultiAd[0].Ad.AdCode),
                                ADTECHClient.__parseBanner__(response.ADTECH_MultiAd[2].Ad.AdCode)
                            ]);
                        });
                    });
                });
