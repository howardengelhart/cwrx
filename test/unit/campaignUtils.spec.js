...
describe('campaignUtils', function() {
    ...
    describe('getAccounts', function() {
        ...
        it('should lookup the advertiser and customer', function(done) {
            campaignUtils.getAccounts(advertColl, custColl, req, nextSpy, doneSpy).catch(errorSpy);
        ...
        it('should call done if one of the two is not found', function(done) {
            ...
            campaignUtils.getAccounts(advertColl, custColl, req1, nextSpy, doneSpy).catch(errorSpy);
            campaignUtils.getAccounts(advertColl, custColl, req2, nextSpy, doneSpy).catch(errorSpy);
