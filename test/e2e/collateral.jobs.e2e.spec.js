...
describe('/api/collateral/job/:reqId', function() {
    ...
    beforeEach(function(done) {
        ...
        mockData = {
            ...
            'b4567': { code: 202, body: { url: '/api/collateral/job/b4567' } },
    ...
    it('should retrieve a status code and body from memcached', function(done) {
        q.allSettled([
            requestUtils.qRequest('get', { url: collateralUrl + '/collateral/job/a1234' }, null, {enabled: false}),
            requestUtils.qRequest('get', { url: collateralUrl + '/collateral/job/b4567' }, null, {enabled: false}),
            requestUtils.qRequest('get', { url: collateralUrl + '/collateral/job/c7890' }, null, {enabled: false})
            ...
            expect(results[1].value.body).toEqual({ url: '/api/collateral/job/b4567' });
    ...
    it('should return a 404 if the result is not found', function(done) {
        requestUtils.qRequest('get', { url: collateralUrl + '/collateral/job/fake3819' }, null, {enabled: false})
        .then(function(resp) {
