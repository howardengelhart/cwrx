    ...
    describe('GET /api/public/placements/:id', function() {
            ...
            mockPlacements = [
                {
	                ...
	                tagType: 'mraid',
	                label: 'foo bar',
	                tagParams: { type: 'full', container: 'box-1', campaign: 'cam-1', branding: 'brandA' }
                },
                {
	                id: 'e2e-pl-2',
	                status: 'active',
	                ...
	                tagParams: { type: 'full', container: 'box-2', campaign: 'cam-2', branding: 'brandB' }
                },
                {
	                id: 'e2e-pl-inactive',
	                status: 'inactive',
	                user: 'u-selfie',
	                org: 'o-selfie',
	                tagParams: { type: 'full', container: 'box-2', campaign: 'cam-2', branding: 'brandC' }
                },
                {
	                id: 'e2e-deleted',
	                status: 'deleted',
        ...
        describe('if the url extension is .js', function() {
            it('should return the placement as a CommonJS module if the extension is .js', function(done) {
                ...
                requestUtils.qRequest('get', options).then(function(resp) {
                    expect(resp.response.statusCode).toBe(200);
                    expect(resp.body).toBe('module.exports = {"id":"e2e-pl-2","status":"active","tagParams":{"type":"full","container":"box-2","campaign":"cam-2","branding":"brandB"}};');
