...
describe('/api/content/job/:reqId', function() {
    ...
    beforeEach(function(done) {
        ...
        mockData = {
            ...
            'b4567': { code: 202, body: { url: '/api/content/job/b4567' } },
    ...
    it('should retrieve a status code and body from memcached', function(done) {
        q.allSettled([
            requestUtils.qRequest('get', { url: contentUrl + '/content/job/a1234' }, null, {enabled: false}),
            requestUtils.qRequest('get', { url: contentUrl + '/content/job/b4567' }, null, {enabled: false}),
            requestUtils.qRequest('get', { url: contentUrl + '/content/job/c7890' }, null, {enabled: false})
            ...
            expect(results[1].value.body).toEqual({ url: '/api/content/job/b4567' });
    ...
    it('should return a 404 if the result is not found', function(done) {
        requestUtils.qRequest('get', { url: contentUrl + '/content/job/fake3819' }, null, {enabled: false})
        .then(function(resp) {
