 ...
 *     been loaded.
 */
AdLoader.prototype.loadAds = function loadAds(experience, campaign, origin, uuid) {
    var log = logger.getLog();
    ...
    return this.fillPlaceholders(
        experience, campaign, origin, uuid
 ...
 *     found.)
 */
AdLoader.prototype.findCard = function findCard(campaign, context, origin, uuid) {
    var log = logger.getLog();
