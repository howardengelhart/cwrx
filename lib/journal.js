(function(){
    ...
    util.inherits(AuditJournal, Journal); //TODO: is this the best way to do this?
    ...
    AuditJournal.prototype.middleware = function(req, res, next) {
        ...
        var data = {
            ...
            params: req.params, //TODO: include these + query if empty?
            query: req.query
        };
        
        self.write(req.session.user, data);
