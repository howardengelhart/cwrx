(function(){
    ...
    signatures.signData = function(data, hmacAlgorithm, secret) {
    ...
    signatures.Authenticator.prototype.setHeaders = function(method, reqOpts) {
        ...
        var signature = signatures.signData(data, self.hmacAlgorithm, self._creds.secret);
    ...
    signatures.Verifier.prototype.middlewarify = function(required) {
        ...
        return function authorize(req, res, next) {
            ...
            .then(function(app) {
                ...
                var computedSig = signatures.signData(signData, self.hmacAlgorithm, app.secret);
