(function(){
    ...
    // Return a copy of the app object with sensitive fields removed. Also calls unescapeKeys()
    mongoUtils.safeApplication = function(app) {
        if (!app || typeof app !== 'object') {
            return app;
        }
        var newApp = {};
        for (var key in app) {
            if (key !== 'secret' && key !== '_id') {
                newApp[key] = app[key];
            }
        }
        return mongoUtils.unescapeKeys(newApp);
    };
