...
//TODO: probably makes sense to break this up into multiple libs
    ...
    //TODO: consider caching promises for adtech calls to minimize duplicate calls?
    ...
    campaignUtils.editCampaign = function(adtechId, name, keys) {
        ...
        .catch(function(error) {
            //TODO: should we grab the error if the campaign is not found + just warn?
