...
Aggregator.prototype.autoflush = function autoflush(interval) {
    ...
    // Replace this instance's autoflush() method with a function that will first clear the existing
    // interval before calling Aggregator.prototype.autoflush(). This way, the next time autoflush()
    // is called, the old interval will be cleaned up first.
