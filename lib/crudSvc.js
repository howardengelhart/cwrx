(function(){
    ...
    function CrudSvc(coll, prefix, opts, cache) {
        opts = opts || {};
        opts.reqTimeouts = opts.reqTimeouts || {};
        ...
        self.reqTimeouts = {
            enabled: (opts.reqTimeouts.enabled && !!cache) || false, // default = turned off for now
            timeout: opts.reqTimeouts.timeout || 5*1000,
            cacheTTL: opts.reqTimeouts.cacheTTL || 24*60*60*1000,
        };
     ...
     */
    CrudSvc.prototype.checkReqTimeout = function(req, promiseResult, timeoutObj) {
        var self = this,
            log = logger.getLog(),
            body;
