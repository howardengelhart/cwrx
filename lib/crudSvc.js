(function(){
     ...
     * object ids. opts is an optional hash of options, such as the objName (defaults to the
     * collection name), and userProp and orgProp, booleans (default to true) which determine
     * whether the user/org properties should be defaulted into new objects.
     */
        ...
        self.runMiddleware(req, 'read', function() {
            ...
            .then(function(results) {
                ...
                if (objList.length === 0) {
                    ...
                    resp.code = 200;
                    resp.body = multiGet ? objList : objList[0];
                }
