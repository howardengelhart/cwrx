(function(){
    ...
    function CrudSvc(coll, prefix, opts) {
        ...
        //TODO: also, should we be able to turn off this logic? probably...
        self.reqTimeout = opts.reqTimeout || 20*1000; //TODO: rename? rethink?
        self.reqCacheTTL = opts.reqCacheTTL || 24*60*60*1000; //TODO: rename? rethink?
    ...
    CrudSvc.prototype.setReqTimeout = function(req, res) {
        ...
        timeoutObj.timeout = setTimeout(function() {
            ...
            cache.add('req:' + req.uuid, { code: 202, body: { reqId: req.uuid } }, self.reqCacheTTL)
            .then(function() {
