(function(){
     ...
     */
    function CrudSvc(coll, prefix, opts, jobManager) {
        opts = opts || {};
    ...
    CrudSvc.prototype.getObjs = function(query, req, res, multiGet) {
        ...
        var timeoutObj = self.jobManager.setJobTimeout(req, res);
        ...
        return deferred.promise.finally(function() {
            return self.jobManager.checkJobTimeout(req, deferred.promise.inspect(), timeoutObj);
        });
    };
