(function(){
    ...
    function CrudSvc(coll, prefix, opts, schema) {
        ...
        //TODO: should test this schema stuff
        schema.id = {
        ...
        self._middleware = {
            read   : [],
            create : [self.model.midWare.bind(self.model, 'create'),
                      self.setupObj.bind(self)],
            edit   : [self.checkExisting.bind(self, 'edit'),
                      self.model.midWare.bind(self.model, 'edit')],
            delete : [self.checkExisting.bind(self, 'delete')]
        };
        
        /* TODO: revisit, this will cause so many problems
        ...
        */
        ...
        if (opts.statusHistory) {
            ...
            self.model._schema.statusHistory = {
                _accessLevel: AccessLevel.Forbidden,
                _type: ['object'],
                _locked: true
            };
