(function(){
    ...
    var q               = require('q'),
        ...
        jobTimeouts     = require('./jobTimeouts'),
        Scope           = enums.Scope,
        Status          = enums.Status;
    ...
    function CrudSvc(coll, prefix, opts, cache) {
        opts = opts || {};
        opts.jobTimeouts = opts.jobTimeouts || {};
        ...
        self.jobCfg = {
            enabled: (opts.jobTimeouts.enabled && !!cache) || false, // default = turned off for now
            timeout: opts.jobTimeouts.timeout || 5*1000,
            cacheTTL: opts.jobTimeouts.cacheTTL || 60*60*1000,
            urlPrefix: opts.jobTimeouts.urlPrefix || ''
        };
    ...
    CrudSvc.prototype.getObjs = function(query, req, res, multiGet) {
        ...
        var timeoutObj = jobTimeouts.setJobTimeout(self.cache, self.jobCfg, req, res);
        ...
        return deferred.promise.finally(function() {
            return jobTimeouts.checkJobTimeout(self.cache, self.jobCfg, req,
                                               deferred.promise.inspect(), timeoutObj);
        });
    };
