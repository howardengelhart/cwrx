...
module.exports = function(cacheTTL, cache) {
    ...
    /**
     * Perms should be an object whose keys are database objects, and the values are strings of the
     * verbs required for the method. For example, { experiences: "write" }. This will check that
     * each dbObject-verb pair in perms exists in userPerms (ignoring scopes).
     */
    ...
    /** 
     * Checks that the user with the given id exists, is active, and has the required permissions.
