(function(){
    ...
    authUtils.mergePermissions = function(policies) { //TODO: test, comment
        ...
        // clear off anything with scope === 'deny' //TODO: unsure of this...
    ...
    authUtils.mergeValidation = function(policies) { //TODO: test, comment
        ...
        policies.sort(function(a, b) {
            return b.priority - a.priority; //TODO: check if this preserves id order?
        }).forEach(function(policy) {
            // TODO: may want to more carefully test that this works
