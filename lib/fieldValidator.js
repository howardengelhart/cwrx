(function(){
     ...
     * if that field should be forbidden. If there are multiple functions for the conditionally
     * forbidden field, it does an AND on the results of those functions.
     */
