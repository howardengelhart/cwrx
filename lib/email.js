(function(){
    ...
    email.notifyMultipleLoginAttempts = function(sender, recipient, resetPasswordLink) {
        var subject = 'Need help logging in?',
            data = {
                contact: sender,
                link: resetPasswordLink
            };
        return email.compileAndSend(sender, recipient, subject, 'suggestPasswordReset.html', data);
    };
