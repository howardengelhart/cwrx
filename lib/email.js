(function(){
    ...
    email.campaignEnded = function(sender, recipient, campName, dashboardLink) {
        var data = {
            campName: campName,
    ...
    email.newUpdateRequest = function(sender, recipient, userEmail, company, campName, reviewLink) {
        var data = {
            userEmail: userEmail,
            campName: campName,
        ...
        return email.compileAndSend(
            sender,
            recipient,
            'New update request from ' + company + ' for campaign "' + campName + '"',
