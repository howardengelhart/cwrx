...
(function(){
    ...
    // TODO: update Initialize a cache using a list of servers (CSV or array) and optional timeout values
    cacheLib.Cache = function(servers, readTimeout, writeTimeout) {
        ...
        Object.defineProperty(self, 'cacheReady', {
            get : function() {
                return self._memcached && self._memcached.servers.length > 0;
            }
        });
    ...
    cacheLib.Cache.prototype._memcachedCommand = function(cmd, opType, args) {
        ...
        .catch(function(error) { //TODO: may want to remove all logging here
    ...
    cacheLib.Cache.prototype.checkConnection = cacheLib._callIfReady(function() {
        return this._memcachedCommand('stats', 'read').thenResolve(true); //TODO: change timeout?
    });
    ...
    cacheLib.createCache = function(servers, readTimeout, writeTimeout) {
        return q.fcall(function() {
            var cache = new cacheLib.Cache(servers, readTimeout, writeTimeout);
