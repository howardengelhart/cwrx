...
(function(){
    ...
    pubsub.Publisher = function(name, connCfg) {
        ...
        if (self.connCfg.path) { // TODO: extra handling for socket file?
    ...
    //TODO: rethink? do we actually need this? do we need to try/catch the _server.close()?
    ...
    pubsub.Subscriber = function(name, connCfg, reconnectDelay) {
        ...
        self.name = name;
        self.connCfg = connCfg;
        self.reconnectDelay = reconnectDelay || 5000; //TODO: revisit
        self.isConnected = false;
        self.lastMsg = null; //TODO: rename?
